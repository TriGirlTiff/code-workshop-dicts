...
def add_new_shopping_list(shopping_dict, store_name):
    ...
    Arguments:
      shopping_dict: dict of shopping lists
      store_name: string name of the new list to add
    Returns:
      None
    """
...
def remove_shopping_list(shopping_dict, store_to_remove):
    ...
    Arguments:
      shopping_dict: dict of shopping lists
      store_to_remove: string name of the list to remove
    Returns:
      None
    """
...
def display_shopping_list(shopping_dict, list_name):
    """Print the contents of a shopping list.

    If the list is missing, print a message saying so. This function is
    case sensitive.
...
def get_menu_choice():
    ...
    4 - Add item(s) to a shopping list.
    5 - Remove items(s) from a shopping list.
    6 - Remove a list by name.
    7 - Exit the program.\n
    """
    print menu
...
def execute_repl(shopping_lists_by_name):
    ...
    while True:
        ...
        if choice == 0:
            ...
            # all of the remaining choices require an existing list. First, run
